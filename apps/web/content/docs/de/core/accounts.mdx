...
- Data Konten: Dieses Feld speichert in der Regel Zustandsdaten, die gelesen
  werden sollen.
...
ein [Datenkonto](#data-accounts) ist
...
separate Dateien für Programme und deren Daten haben.)
...
Programmcode in ihrem data Feld. Stattdessen verweist ihr data Feld auf ein
...
executable Feld auf true gesetzt ist, was darauf hinweist, dass das Konto ein
Programm ist.
