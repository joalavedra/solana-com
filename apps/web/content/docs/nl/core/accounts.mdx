...
[rent](/docs/references/terminology#rent), waardoor de data on-chain kan worden
opgeslagen. Rent is evenredig aan de grootte van het account.
...
<Callout>
  Tijdens programma-implementatie of upgrades worden bufferaccounts gebruikt om
