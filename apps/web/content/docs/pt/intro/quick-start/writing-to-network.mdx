...
1. Aloque o [número de bytes](mention:space) necessários para armazenar os dados
   do mint.
2. [Transfira lamports](mention:lamports) da carteira para financiar a nova
   conta.
3. [Atribua a propriedade](mention:programId) da conta ao
...
- [2 casas decimais](mention:decimals)
