...
entre cuentas de cartera y cuentas de programa. La cuenta de programa almacena
el bytecode compilado para el
...
Una
[cuenta mint](https://github.com/solana-program/token/blob/program%40v8.0.0/program/src/state.rs#L16-L30)
...
la cuenta mint identifica de manera única a un token en la red Solana.
...
Las cuentas mint almacenan estado, no código ejecutable. Son propiedad del Token
Program, que incluye instrucciones que definen cómo crear y actualizar cuentas
mint.
