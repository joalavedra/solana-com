...
clients από το αρχείο IDL ενός προγράμματος. Οι δημιουργημένοι clients
περιλαμβάνουν λειτουργίες για την κλήση εντολών και την ανάκτηση λογαριασμών,
...
αρχείο IDL, ποιες γλώσσες προγραμματισμού πελάτη θα δημιουργηθούν και πού θα
εξαχθεί ο παραγόμενος κώδικας. Δημιουργήστε αυτή τη διαμόρφωση εκτελώντας:

```terminal
$ npx codama init
```

Αυτό θα σας εμφανίσει ερωτήσεις για να δημιουργήσετε ένα αρχείο `codama.json`
στον ριζικό κατάλογο του project σας και να εγκαταστήσετε τις απαραίτητες
εξαρτήσεις του Codama.
...
Αυτό θα δημιουργήσει τους πελάτες του προγράμματος στις
