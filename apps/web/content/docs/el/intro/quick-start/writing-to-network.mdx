...
Δημιουργήστε ένα keypair για το mint account. Το δημόσιο κλειδί θα
χρησιμοποιηθεί ως διεύθυνση του mint account.
...
διατεθούν για τα δεδομένα σε ένα mint account.
...
3. [Αναθέστε την ιδιοκτησία](mention:programId) του λογαριασμού στο
