...
Создайте соединение с кластером Solana.
...
Сгенерируйте новые [ключевые пары](/docs/core/accounts#public-key) для
использования в качестве аккаунтов отправителя и получателя.
...
Сгенерируйте новую ключевую пару для использования в качестве кошелька.

### !mint

Сгенерируйте новую ключевую пару для использования в качестве адреса
создаваемого Mint аккаунта.
...
1. Выделите [количество байтов](mention:space), необходимое для хранения данных
   mint.
2. [Переведите лампорты](mention:lamports) с кошелька для финансирования нового
   аккаунта.
