...
программы. Для аккаунтов кошельков это поле имеет значение `false`.
...
является полем в самом [типе аккаунта](/docs/core/accounts#account-structure),
но включено в ответ.
...
скомпилированный байткод исходного кода Token Program
