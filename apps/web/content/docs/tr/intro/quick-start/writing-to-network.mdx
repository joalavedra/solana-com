...
Tüm cüzdan hesapları System Program tarafından sahiplenilir. SOL transferi
yapmak için, System Program'ın
...
Rent muafiyeti için gereken lamport miktarını hesaplayın
...
Bir token oluşturmak için hem `@solana/web3.js` hem de `@solana/spl-token`
kütüphanelerini kullanmak gerekir. Aşağıdaki örnekteki kod şunları yapacaktır:
...
3. Hesabın [sahipliğini](mention:programId)
   [Token Extensions program](/docs/tokens/extensions)'a
...
[Token Extensions Program](mention:programId)'ın
