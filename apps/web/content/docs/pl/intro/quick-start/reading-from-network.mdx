...
zrozumieć strukturę kont Solana [konta](/docs/core/accounts). Każde konto Solana
...
[dane stanu lub wykonywalny program](/docs/core/accounts#types-of-accounts).
...
wykonywalnego. W przypadku kont portfela to pole ma wartość `false`.
