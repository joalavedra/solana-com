...
- Публічний ключ, який слугує адресою акаунта
...
Кожен акаунт повинен мати мінімальний баланс lamport, який називається
...
Читання даних з акаунта Solana включає два кроки:
...
Раніше це поле відстежувало, коли акаунт повинен був платити rent. Однак цей
...
обліковим записом. (Для простоти, ви можете вважати програмний обліковий запис
самою програмою.)
...
програми**, який містить код програми. (Дивіться діаграму нижче.)
...
<Callout>
  ...
  використовуються для тимчасового зберігання завантаження.
</Callout>

Приклад нижче отримує обліковий запис Token Program. Зверніть увагу, що поле
`executable` встановлено як `true`, що вказує на те, що обліковий запис є
програмою.
