...
عندما تقدم [معاملة](/docs/core/transactions)، ينفذ نظام تشغيل سولانا كل تعليمة
بالتسلسل وبشكل ذري. توضح الأمثلة في هذا القسم كيفية بناء وإرسال المعاملات
...
المثال أدناه يحول SOL بين حسابين. كل حساب له برنامج مالك، وهو البرنامج الوحيد
الذي يمكنه خصم رصيد SOL من الحساب.
...
حساب وحدات lamport المطلوبة للإعفاء من rent
...
3. [تعيين ملكية](mention:programId) الحساب إلى
   [برنامج امتدادات العملة الرمزية](/docs/tokens/extensions).
...
التعليمة الثانية تستدعي [برنامج امتدادات العملة الرمزية](mention:programId)
وتعليمة `createInitializeMint2Instruction` لتهيئة حساب العملة بالبيانات التالية:
