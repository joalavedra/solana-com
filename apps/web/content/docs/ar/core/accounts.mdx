...
كل برنامج مملوك من قبل [برنامج محمّل](/docs/core/programs#loader-programs)،
والذي يُستخدم لنشر وإدارة الحساب. عندما يتم نشر [برنامج](/docs/core/programs)
جديد، يتم إنشاء حساب لتخزين رمزه [القابل للتنفيذ](#executable). يُسمى هذا بحساب
